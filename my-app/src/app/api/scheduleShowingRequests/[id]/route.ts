...
function getAuthToken(req: Request): string | null {
  ...
  export async function DELETE(req: Request) {
      ...
      try {
        ...
        //https://www.idxhome.com/api/v1/client/scheduleShowingRequests.json
        console.log(`https://www.idxhome.com/api/v1/client/scheduleShowingRequests/${id}.json`);
        await axios.delete(`https://www.idxhome.com/api/v1/client/scheduleShowingRequests/${id}.json`, {
          headers: {
            Authorization: token,
