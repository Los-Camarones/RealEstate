...
export async function GET(req: Request) {
  ...
  try {
    ...
    let API_URL: string;
    if(id) {
      API_URL = `https://www.idxhome.com/api/v1/client/scheduleShowingRequests.json`;
    } else {
      ...
      API_URL = `https://www.idxhome.com/api/v1/client/scheduleShowingRequests.json?fields=${fields}&offset=${offset}&limit=${limit}`;   
    }
