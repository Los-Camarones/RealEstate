...
describe('Listings Page Performance Tests', () => {
  ...
  it('should run Lighthouse performance test for the listings page', (done) => {
    exec('lighthouse http://localhost:3000/property-search?boardId=6&boundaryWKT=POLYGON%28%28-122.46650681249976%2039.31045722434712%2C-120.2692411874999%2039.31045722434712%2C-120.2692411874999%2037.4961722512508%2C-122.46650681249976%2037.4961722512508%2C-122.46650681249976%2039.31045722434712%29%29&bedrooms=0&bathCount=0&propertyType=SFR,CND&status=active&sort=importDate&dateRange=0 --output=json --output-path=./__tests__/PerformanceTests/reports/listings-page-report.json', (err, stdout, stderr) => {
      if (err) {
