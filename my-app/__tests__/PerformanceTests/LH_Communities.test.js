...
describe('Communities Page Performance Tests', () => {
  ...
  it('should run Lighthouse performance test for the Communities page', (done) => {
    exec('lighthouse http://localhost:3000/markets --output=json --output-path=./__tests__/PerformanceTests/reports/communities-page-report.json', (err, stdout, stderr) => {
      if (err) {
