...
describe('HomeWorth (Valuation) Page Performance Tests', () => {
  ...
  it('should run Lighthouse performance test for the HomeWorth (Valuation) page', (done) => {
    exec('lighthouse http://localhost:3000/valuation --output=json --output-path=./__tests__/PerformanceTests/reports/homeworth-page-report.json', (err, stdout, stderr) => {
      if (err) {
